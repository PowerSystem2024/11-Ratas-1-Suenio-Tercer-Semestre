...
class Teclado extends DispositivoEntrada{
    static contadoresTeclado = 0;

    constructor(tipoEntrada, marca){
        super(tipoEntrada, marca);
        this._idTeclado = ++Teclado.contadoresTeclado;
    }
    get idTeclado(){
...
console.log(`${computadora1}`) //llamamos a tostring
...
class Orden{
    ...
    mostrarOrden(){ // equivale al to string
...
orden1.agregarComputadora(computadora2); // se puede repetir
orden1.mostrarOrden();
